...
def test_volume_size_refresh(mocker, boto3_stubber, section_dict, expected_value):
    ...
    if mocked_pcluster_config.get_section("ebs", "default").get_param_value(
        "volume_size"
    ) is None and mocked_pcluster_config.get_section("ebs", "default").get_param_value("ebs_snapshot_id"):
